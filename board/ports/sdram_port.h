...
/* stm32f4 Bank1:0XC0000000  Bank2:0XD0000000 前面8M用于EMWIN*/
#define SDRAM_BANK_ADDR                 ((uint32_t)0XC0000000 + 0x800000 + 0x100)
/* data width: 8, 16, 32 */
...
#define MEMHEAP_SDRAM_SIZE              (SDRAM_SIZE - 0x800000 - 0x100)
