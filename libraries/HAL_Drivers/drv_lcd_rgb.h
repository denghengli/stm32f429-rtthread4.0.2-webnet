#ifndef __DRV_LCD_RGB_H
#define __DRV_LCD_RGB_H
#include <rtthread.h>
#include "rtdevice.h"
...
//-----------------MCU屏 LCD端口定义---------------- 
//LCD背光	PB6
#define LCD_BL GET_PIN(B, 6)
#define LCD_BL_INIT rt_pin_mode(LCD_BL, PIN_MODE_OUTPUT);
#define LCD_BL_ON   rt_pin_write(LCD_BL, PIN_LOW)
#define LCD_BL_OFF  rt_pin_write(LCD_BL, PIN_HIGH)
